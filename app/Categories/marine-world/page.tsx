...
export default function MarineWorldPage() {
  ...
  const products = [
    ...
    },
    {
      ...
      image: '/images/Products/marine/landhoow-boat-bilge-water-pump.jpg',
      price: 150.00,
      priceRange: '$150 up',
    ...
    // FISHING GEAR PRODUCTS (KEEPING YOUR EXISTING)
    {
      ...
      price: 25.00,
      image: "/images/Products/fishing/jig-assist-hooks.jpg",
    ...
    },
    {
      ...
      price: 10.00,
      image: "/images/Products/fishing/mustad-big-gun-hooks.jpg",
    ...
    },
    {
      ...
      image: '/images/Products/marine/yamaha-power-head-gasket.jpg',
      price: 450.00,
      category: 'boat-parts',
      availability: 'In Stock',
...
},
{
  ...
  specs: {
    ...
    
    {
      ...
      image: '/images/Products/marine/fuel-primer-bulb.jpg?v=2',
      price: 75.00,
      priceRange: '$75.00',
      category: 'boat-parts',
      availability: 'In Stock',
    ...
    },
    {
      id: 'fuel-clip',
      name: 'Fuel Clip',
      image: '/images/Products/marine/fuel-clip.jpg?v=2',
      price: 60.00,
      priceRange: '$60.00',
      category: 'boat-parts',
      availability: 'In Stock',
    ...
    },
    {
      id: 'fuel-line-kit',
      name: 'Fuel Line Kit',
      image: '/images/Products/marine/fuel-line-kit.jpg?v=2',
      price: 250.00,
      priceRange: '$250.00',
      category: 'boat-parts',
      availability: 'In Stock',
    ...
    // FISHING LURES PRODUCTS (KEEPING YOUR EXISTING)
    {
      ...
      price: 6.00,
      image: "/images/Products/marine/fishing-reels-yoyo.jpg",
    ...
    },
    {
      ...
      price: 65.00,
      image: "/images/Products/fishing/mustad-lures.jpg",
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                   ...
                   <Link
                      href={`/order?product=${encodeURIComponent(selectedProduct.name)}&category=Marine%20World`}
