...
const CATALOG: Item[] = [
  ...
  { n: 'Razer PS5 Quick Charging Stand', p: 399, c: 'gaming' },
  ...
  { n: 'Apple AirPods 3rd Generation', p: 650, c: 'earbuds' },
  { n: 'JBL Vibe Buds', p: 220, c: 'earbuds' },
  { n: 'Yesido TWS32 (ANC)', p: 140, c: 'earbuds' },
  { n: 'Premium Wireless Earbuds Pro (ANC)', p: 89, c: 'earbuds' },
  { n: '2000 Series Wireless Headphones (Pink)', p: 150, c: 'earbuds' },
  { n: 'Buds2 Pro', p: 120, c: 'earbuds' },
  ...
  { n: 'Skull Candy STOMP', p: 950, c: 'speakers' },
  { n: 'Skull Candy Barrel', p: 999, c: 'speakers' },
  { n: 'Fugoo Tough', p: 200, c: 'speakers' },
  // ---- WATCHES ----
  { n: 'Casio Analog 1500WH-1BV', p: 200, c: 'watches' },
  { n: 'Casio Analog 1400WH-1AV', p: 200, c: 'watches' },
  { n: 'PEJE Smartwatch', p: 175, c: 'watches' },
  { n: 'PEJE Classic Round', p: 175, c: 'watches' },
  { n: 'PEJE Sport Smartwatch', p: 175, c: 'watches' },
  { n: 'M900 Watch Pro', p: 175, c: 'watches' },
  { n: 'PEJE ZW Series 10', p: 175, c: 'watches' },
  { n: 'PEJE ZW Ultra X', p: 175, c: 'watches' },
  { n: 'PEJE T800 Ultra 2 Max', p: 175, c: 'watches' },
  ...
  { n: 'StudioZ Wired & Wireless Mic', p: 80, c: 'microphones' },
  ...
  { n: 'Dolphin MCX11 UHF Wireless Mic', p: 200, c: 'microphones' },
  // ---- AUDIO INTERFACES ----
  { n: 'WaveMixer Bluetooth Multi-Channel Interface', p: 75, c: 'audio-interfaces' },
  { n: 'Audiopipe 2 Channel Guitar-Singer Console', p: 350, c: 'audio-interfaces' },
  { n: 'Audiopipe 2 Channel Audio Interface', p: 450, c: 'audio-interfaces' },
  // ---- CAR AUDIO ----
  ...
  { n: 'Pioneer 4" Speaker TS-F1034R', p: 155, c: 'car-audio' },
  { n: 'Pioneer 5 1/4" 2-Way Speaker', p: 160, c: 'car-audio' },
  { n: 'XXX 3-Way Triaxial Car Speaker', p: 160, c: 'car-audio' },
  { n: 'Pipeman Trunk Kit', p: 200, c: 'car-audio' },
  { n: 'Pioneer Dome Tweeter TS-S20', p: 300, c: 'car-audio' },
  ...
  { n: 'Philips M344 Wireless Mouse', p: 75, c: 'mouse' },
  { n: 'Philips M413 Wireless Mouse', p: 75, c: 'mouse' },
  // ---- SELFIE / GIMBALS ----
  { n: 'Digipower Quikpod Selfie Stick', p: 60, c: 'selfie' },
  { n: 'R16K Selfie Stick with Tripod', p: 75, c: 'selfie' },
  { n: 'Smart M2 Pro Selfie Stick', p: 250, c: 'selfie' },
  ...
  // ---- CAR ACCESSORIES ----
  { n: 'Yesido Car Holder C267', p: 50, c: 'car-accessories' },
  { n: 'RCA Car Holder', p: 60, c: 'car-accessories' },
  { n: 'Yesido Car Holder C173', p: 60, c: 'car-accessories' },
  { n: 'Yesido Car Holder C261', p: 60, c: 'car-accessories' },
  { n: 'Yesido USB Transmitter', p: 60, c: 'car-accessories' },
  { n: 'Yesido Audio Adapter', p: 60, c: 'car-accessories' },
  { n: 'HyperGear Universal Phone Holder', p: 80, c: 'car-accessories' },
  { n: 'C15 Car MP3 Player (RGB)', p: 100, c: 'car-accessories' },
  { n: 'Car F2 FM Transmitter', p: 100, c: 'car-accessories' },
  { n: 'AudioBox FM Transmitter', p: 100, c: 'car-accessories' },
  { n: 'Yesido Wireless CarPlay Adapter', p: 120, c: 'car-accessories' },
  // ---- POWER BANKS ----
  { n: 'Anker Pocket-Sized 10000mAh', p: 75, c: 'powerbanks' },
  { n: 'Anker PowerCore Select 10000mAh', p: 85, c: 'powerbanks' },
  { n: 'Yesido Wireless Power Bank (w/ cables)', p: 95, c: 'powerbanks' },
  { n: 'HyperGear PowerPack Mini 5000mAh', p: 99, c: 'powerbanks' },
  { n: 'Pocket Juice Air Plus 10000mAh', p: 99, c: 'powerbanks' },
  { n: 'Pocket Juice Power Bank (Flashlight)', p: 100, c: 'powerbanks' },
  { n: 'Airbro ONE Portable Fan + Powerbank', p: 140, c: 'powerbanks' },
  { n: 'HyperGear ClearCharge XL 20000mAh', p: 180, c: 'powerbanks' },
  ...
  // ---- STORAGE ----
  { n: 'SanDisk Cruzer 16GB', p: 50, c: 'storage' },
  { n: 'SanDisk Memory Card 16GB', p: 50, c: 'storage' },
  { n: 'ADATA USB 3.2 32GB', p: 80, c: 'storage' },
  { n: 'ADATA Memory Card 32GB', p: 80, c: 'storage' },
  { n: 'SanDisk Cruzer 64GB', p: 100, c: 'storage' },
  { n: 'SanDisk Ultra Dual Drive 64GB', p: 100, c: 'storage' },
  { n: 'SanDisk Memory Card 64GB', p: 100, c: 'storage' },
  { n: 'SanDisk Cruzer 128GB', p: 120, c: 'storage' },
  { n: 'SanDisk Memory Card 128GB', p: 120, c: 'storage' },
